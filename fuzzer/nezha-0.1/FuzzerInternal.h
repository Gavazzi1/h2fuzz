...
typedef int64_t (*UserCallback)(const uint8_t *Data, size_t Size);
...
public:
  ...
  /// TODO new mutations here
  size_t Mutate_ChangeCase(uint8_t *Data, size_t Size, size_t MaxSize);
  size_t Mutate_ClearField(uint8_t *Data, size_t Size, size_t MaxSize);
  size_t Mutate_AddCharAtBeginning(uint8_t *Data, size_t Size, size_t MaxSize);
  size_t Mutate_AddCharAtEnd(uint8_t *Data, size_t Size, size_t MaxSize);
  size_t Mutate_SetWordFromManualDictionary(uint8_t *Data, size_t Size, size_t MaxSize);
